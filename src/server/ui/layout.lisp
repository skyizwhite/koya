(defpackage #:koya-server/ui/layout
  (:use #:cl #:hsx)
  (:import-from #:jingle
                #:set-response-header)
  ...
  (:import-from #:koya-server/lib/assets
                #:asset-url)
  (:import-from #:koya-server/lib/urls
                #:space-url)
  (:import-from #:koya-server/ui/icon
                #:~icon)
  (:import-from #:koya-server/ui/toast
                #:~toast #:take-toast)
  (:export #:~layout
           #:~footer
           #:logout))
(in-package #:koya-server/ui/layout)
