(defpackage #:koya-server/features/contents/bulk
  (:use #:cl)
  ...
  (:export #:bulk-action-p
           #:apply-to-each))
(in-package #:koya-server/features/contents/bulk)

;;; What is done to a selection of contents: one at a time through the service,
