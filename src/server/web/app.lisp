(defpackage #:koya-server/web/app
  ...
  (:import-from #:koya-server/web/middlewares
                #:*body-file-middleware* #:*temporary-file-middleware* #:*body-limit-middleware*
                #:*cache-control-middleware* #:*delivery-cors-middleware*)
...
(defun build-app ()
  ...
  (install-middleware *page-app* *body-file-middleware*)
