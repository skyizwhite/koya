...
(deftest dsl
  ...
  (let* ((schema (current-schema))
    ...
    (ok (signals (macroexpand-1 '(defmodel (website badkind) (:kind :table) (title :text))) 'error) ":kind must be :list or :object")
...
(deftest redefinition
  (defspace website)
  (defmodel (website blog) (:kind :list) (title :text))
...
(deftest errors
  ...
  (defspace website)
  (defmodel (website blog) (:kind :list) (tags :reference :model ghost))
