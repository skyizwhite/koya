(defpackage #:koya-tests/server/pages/media
  (:use #:cl #:rove)
  (:import-from #:koya-tests/server/pages/support #:post-login #:edit #:moved-to #:*secret* #:*cookie* #:blog-model #:request #:location #:request-url #:call-action #:setup-pages #:log-in)
